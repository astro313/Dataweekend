...
# For the house we want to value, provide features in the same order as training set.
house_to_value = [
    # House features
    2006,   # year_built
    1,      # stories
...
print type(homes_to_value)
predicted_home_values = model.predict(homes_to_value)

# only predicting price of one house, just look at the first prediction returned
