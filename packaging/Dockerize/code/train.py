...
# #############################################################################
# Load directory paths for persisting model and metadata, passed as env defined in Dockerfile at build time, or can be read from a config. file at build time
